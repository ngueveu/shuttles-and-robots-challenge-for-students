...
// 6 : 1 2 1 4: 2 9 6 2 : 2
// 5 : 2 3 4 3: 1 7 5 1 : 2
// 3 : 3 4 2 1 4 : 3 4 3 2 1 : 2
// 4 : 4 3 3 4  : 5 2 1 3 : 2
// 1 : 2 1 2 3 4 : 1 3 2 4 2 : 2
// 2 : 4 1 1 2 3 : 4 4 3 5 1 : 2
...
const vector<vector<int>> Prod_seqdeposte{  { POSTE_1, POSTE_2, POSTE_1, POSTE_4 },
                                            { POSTE_2, POSTE_3, POSTE_4, POSTE_3 },
                                            { POSTE_3, POSTE_4, POSTE_2, POSTE_1, POSTE_4 },
                                            { POSTE_4, POSTE_3, POSTE_3, POSTE_4 },
                                            { POSTE_2, POSTE_1, POSTE_2, POSTE_3, POSTE_4 },
                                            { POSTE_4, POSTE_1, POSTE_1, POSTE_2, POSTE_3 }
};

const vector<vector<int>> Prod_dureeparposte{   { 2, 9, 6, 2 },
                                                { 1, 7, 5, 1 },
                                                { 3, 4, 3, 2, 1 },
                                                { 5, 2, 1, 3 },
                                                { 1, 3, 2, 4, 2 },
