...
// 1 : 4 3 4 3 4: 12 12 12 12 12: 1
// 2 : 3 4 3 4 3: 12 12 12 12 12: 1
// End
...
const vector<vector<int>> Prod_seqdeposte{  { POSTE_4, POSTE_3, POSTE_4, POSTE_3, POSTE_4 },
                                            { POSTE_3, POSTE_4, POSTE_3, POSTE_4, POSTE_3 }
    
};

const vector<vector<int>> Prod_dureeparposte{   { 12, 12, 12, 12, 12 },
                                                { 12, 12, 12, 12, 12 }
