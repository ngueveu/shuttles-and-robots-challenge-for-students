...
const vector<vector<int>> Prod_seqdeposte{  { POSTE_4, POSTE_3, POSTE_3, POSTE_4, POSTE_3 } };

const vector<vector<int>> Prod_dureeparposte{  { 10, 8, 13, 7, 4 } };
