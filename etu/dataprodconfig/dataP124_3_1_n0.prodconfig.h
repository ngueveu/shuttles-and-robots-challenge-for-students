...
const vector<vector<int>> Prod_seqdeposte{  { POSTE_1, POSTE_2, POSTE_4 },
                                            { POSTE_2, POSTE_1 },
                                            { POSTE_4, POSTE_4, POSTE_2, POSTE_2, POSTE_1 }
};

const vector<vector<int>> Prod_dureeparposte{   { 10, 7, 8 },
                                                { 5, 10 },
                                                { 6, 7, 3, 2, 1 }
};
