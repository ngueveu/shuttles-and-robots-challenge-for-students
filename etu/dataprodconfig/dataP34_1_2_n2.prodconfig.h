...
const vector<vector<int>> Prod_seqdeposte{  { POSTE_3, POSTE_3, POSTE_4, POSTE_4, POSTE_3 } };

const vector<vector<int>> Prod_dureeparposte{  { 9, 5, 15, 6, 6 } };
