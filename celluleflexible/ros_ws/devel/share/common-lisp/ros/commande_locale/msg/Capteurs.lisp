...
(cl:defmethod cl:initialize-instance :after ((m <Capteurs>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Capteurs)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name commande_locale-msg:<Capteurs> is deprecated: use commande_locale-msg:Capteurs instead.")))

(cl:ensure-generic-function 'capteurs-val :lambda-list '(m))
(cl:defmethod capteurs-val ((m <Capteurs>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader commande_locale-msg:capteurs-val is deprecated.  Use commande_locale-msg:capteurs instead.")
  (capteurs m))
