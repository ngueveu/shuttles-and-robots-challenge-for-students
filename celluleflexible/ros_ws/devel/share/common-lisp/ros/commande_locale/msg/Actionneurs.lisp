...
(cl:defmethod cl:initialize-instance :after ((m <Actionneurs>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Actionneurs)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name commande_locale-msg:<Actionneurs> is deprecated: use commande_locale-msg:Actionneurs instead.")))

(cl:ensure-generic-function 'actionneurs-val :lambda-list '(m))
(cl:defmethod actionneurs-val ((m <Actionneurs>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader commande_locale-msg:actionneurs-val is deprecated.  Use commande_locale-msg:actionneurs instead.")
  (actionneurs m))
