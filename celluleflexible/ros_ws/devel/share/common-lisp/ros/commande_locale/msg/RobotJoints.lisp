...
(cl:defmethod cl:initialize-instance :after ((m <RobotJoints>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RobotJoints)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name commande_locale-msg:<RobotJoints> is deprecated: use commande_locale-msg:RobotJoints instead.")))

(cl:ensure-generic-function 'joint1-val :lambda-list '(m))
(cl:defmethod joint1-val ((m <RobotJoints>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader commande_locale-msg:joint1-val is deprecated.  Use commande_locale-msg:joint1 instead.")
  (joint1 m))

(cl:ensure-generic-function 'joint2-val :lambda-list '(m))
(cl:defmethod joint2-val ((m <RobotJoints>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader commande_locale-msg:joint2-val is deprecated.  Use commande_locale-msg:joint2 instead.")
  (joint2 m))

(cl:ensure-generic-function 'joint3-val :lambda-list '(m))
(cl:defmethod joint3-val ((m <RobotJoints>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader commande_locale-msg:joint3-val is deprecated.  Use commande_locale-msg:joint3 instead.")
  (joint3 m))

(cl:ensure-generic-function 'joint4-val :lambda-list '(m))
(cl:defmethod joint4-val ((m <RobotJoints>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader commande_locale-msg:joint4-val is deprecated.  Use commande_locale-msg:joint4 instead.")
  (joint4 m))

(cl:ensure-generic-function 'joint5-val :lambda-list '(m))
(cl:defmethod joint5-val ((m <RobotJoints>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader commande_locale-msg:joint5-val is deprecated.  Use commande_locale-msg:joint5 instead.")
  (joint5 m))

(cl:ensure-generic-function 'joint6-val :lambda-list '(m))
(cl:defmethod joint6-val ((m <RobotJoints>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader commande_locale-msg:joint6-val is deprecated.  Use commande_locale-msg:joint6 instead.")
  (joint6 m))

(cl:ensure-generic-function 'joint7-val :lambda-list '(m))
(cl:defmethod joint7-val ((m <RobotJoints>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader commande_locale-msg:joint7-val is deprecated.  Use commande_locale-msg:joint7 instead.")
  (joint7 m))

(cl:ensure-generic-function 'num_robot-val :lambda-list '(m))
(cl:defmethod num_robot-val ((m <RobotJoints>))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<RobotJoints>)))
  ...
  (cl:format cl:nil "int32 joint1~%int32 joint2~%int32 joint3~%int32 joint4~%int32 joint5~%int32 joint6~%int32 joint7~%int32 num_robot~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'RobotJoints)))
  "Returns full string definition for message of type 'RobotJoints"
  (cl:format cl:nil "int32 joint1~%int32 joint2~%int32 joint3~%int32 joint4~%int32 joint5~%int32 joint6~%int32 joint7~%int32 num_robot~%~%~%"))
