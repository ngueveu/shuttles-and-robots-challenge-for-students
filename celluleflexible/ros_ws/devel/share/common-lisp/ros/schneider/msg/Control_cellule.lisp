...
(cl:defmethod cl:initialize-instance :after ((m <Control_cellule>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Control_cellule)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name schneider-msg:<Control_cellule> is deprecated: use schneider-msg:Control_cellule instead.")))

(cl:ensure-generic-function 'memoire-val :lambda-list '(m))
(cl:defmethod memoire-val ((m <Control_cellule>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader schneider-msg:memoire-val is deprecated.  Use schneider-msg:memoire instead.")
  (memoire m))

(cl:ensure-generic-function 'val-val :lambda-list '(m))
(cl:defmethod val-val ((m <Control_cellule>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader schneider-msg:val-val is deprecated.  Use schneider-msg:val instead.")
  (val m))
