...
(cl:defmethod cl:initialize-instance :after ((m <Msg_SensorState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Msg_SensorState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name schneider-msg:<Msg_SensorState> is deprecated: use schneider-msg:Msg_SensorState instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Msg_SensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader schneider-msg:header-val is deprecated.  Use schneider-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <Msg_SensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader schneider-msg:id-val is deprecated.  Use schneider-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'CPI-val :lambda-list '(m))
(cl:defmethod CPI-val ((m <Msg_SensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader schneider-msg:CPI-val is deprecated.  Use schneider-msg:CPI instead.")
  (CPI m))

(cl:ensure-generic-function 'CP-val :lambda-list '(m))
(cl:defmethod CP-val ((m <Msg_SensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader schneider-msg:CP-val is deprecated.  Use schneider-msg:CP instead.")
  (CP m))

(cl:ensure-generic-function 'PS-val :lambda-list '(m))
(cl:defmethod PS-val ((m <Msg_SensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader schneider-msg:PS-val is deprecated.  Use schneider-msg:PS instead.")
  (PS m))

(cl:ensure-generic-function 'DG-val :lambda-list '(m))
(cl:defmethod DG-val ((m <Msg_SensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader schneider-msg:DG-val is deprecated.  Use schneider-msg:DG instead.")
  (DG m))

(cl:ensure-generic-function 'DD-val :lambda-list '(m))
(cl:defmethod DD-val ((m <Msg_SensorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader schneider-msg:DD-val is deprecated.  Use schneider-msg:DD instead.")
  (DD m))
