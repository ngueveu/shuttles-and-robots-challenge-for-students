...
(cl:defmethod cl:initialize-instance :after ((m <Msg_Erreur>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Msg_Erreur)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name shuttles-msg:<Msg_Erreur> is deprecated: use shuttles-msg:Msg_Erreur instead.")))

(cl:ensure-generic-function 'code-val :lambda-list '(m))
(cl:defmethod code-val ((m <Msg_Erreur>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader shuttles-msg:code-val is deprecated.  Use shuttles-msg:code instead.")
  (code m))

(cl:ensure-generic-function 'n_poste-val :lambda-list '(m))
(cl:defmethod n_poste-val ((m <Msg_Erreur>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader shuttles-msg:n_poste-val is deprecated.  Use shuttles-msg:n_poste instead.")
  (n_poste m))
